...
class DashboardController extends Controller
{
    function index() : View {
        ...
        for ($month = 1; $month <= 12; $month++) {
            ...
            $monthlyOrderCounts[] = Order::whereMonth('created_at', $month)->whereYear('created_at', Carbon::now()->year)
            ->count();
        }

        return view('admin.dashboard', compact('todaysOrder', 'thisWeekOrders', 'thisMonthOrders', 'thisYearOrders', 'totalOrders', 'pendingCourses', 'rejectedCourses', 'totalCourses', 'monthlyOrderSums', 'monthlyOrderCounts', 'recentCourses', 'recentBlogs', 'recentOrders'));
    }
}
