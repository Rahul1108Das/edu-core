                                ...
                                <div class="col-xl-6">
                                    <div class="wsus__dashboard_profile_update_info">
                                        ...
                                        <select id="" class="form-control" name="gender">
                                            ...
                                            <option @selected(auth()->user()->email == 'male') value="male">Male</option>
                                            <option @selected(auth()->user()->email == 'female') value="female">Female</option>
                                        </select>
                    ...
                    <div class="wsus__dashboard_contant">
                        <div class="wsus__dashboard_contant_top d-flex flex-wrap justify-content-between">
                            <div class="wsus__dashboard_heading">
                                ...
                                <p>Put your social information here.</p>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('instructor.profile.update-social') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        <label>Github</label>
                                        <input type="text" placeholder="Enter your github url" name="github" value="{{ auth()->user()->github }}">
