            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="add_course_more_info_checkbox">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="certificate" @checked($course?->certificate == 1) value="1" id="flexCheckDefault2">
                ...
                <div class="col-xl-4">
                    <div class="add_course_more_info_radio_box">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" @checked($level->id === $course->course_level_id) name="level"
                                id="id-{{ $level->id }}" value="{{ $level->id }}">
                ...
                <div class="col-xl-4">
                    <div class="add_course_more_info_radio_box">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" @checked($language->id === $course->course_language_id) name="language"
                                id="id-{{ $language->id }}" value="{{ $language->id }}">
