            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse-{{ $chapter->id }}" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div class="add_course_content_action_btn">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li class="add_lesson" data-chapter-id="{{ $chapter->id }}" data-course-id="{{ $chapter->course_id }}"><a class="dropdown-item" href="javascript:;">Add Lesson</a>
                                </li>
                        ...
                        <a class="edit edit_chapter" data-course-id="{{ $chapter->course_id }}" data-chapter-id="{{ $chapter->id }}" href="javascript:;"><i class="far fa-edit"></i></a>
                    ...
                    <div class="accordion-body">
                        <ul class="item_list sortable_list">
                            ...
                            <li class="" data-lesson-id="{{ $lesson->id }}" data-chapter-id="{{ $chapter->id }}">
                                ...
                                <div class="add_course_content_action_btn">
                                    <a class="edit_lesson" data-lesson-id="{{ $lesson->id }}" data-chapter-id="{{ $chapter->id }}" data-course-id="{{ $chapter->course_id }}" href="javascript:;"><i class="far fa-edit"></i></a>
