                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    @if ($feature?->image_one != null)
                                    <x-image-preview src="{{ asset($feature?->image_one) }}" style="background-color: black"/>                                        
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title_one" placeholder="" value="{{ $feature?->title_one }}">
                                    <x-input-error :messages="$errors->get('title_one')" class="mt-2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Subtitle One</label>
                                    <input type="text" class="form-control" name="subtitle_one" placeholder="" value="{{ $feature?->subtitle_one }}">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    @if ($feature?->image_two != null)
                                    <x-image-preview src="{{ asset($feature?->image_two) }}" style="background-color: black"/>                                        
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title_two" placeholder="" value="{{ $feature?->title_two }}">
                                    <x-input-error :messages="$errors->get('title_two')" class="mt-2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Subtitle Two</label>
                                    <input type="text" class="form-control" name="subtitle_two" placeholder="" value="{{ $feature?->subtitle_two }}">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    @if ($feature?->image_three != null)
                                    <x-image-preview src="{{ asset($feature?->image_three) }}" style="background-color: black"/>                                        
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title_three" placeholder="" value="{{ $feature?->title_three }}">
                                    <x-input-error :messages="$errors->get('title_three')" class="mt-2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Subtitle Three</label>
                                    <input type="text" class="form-control" name="subtitle_three" placeholder="" value="{{ $feature?->subtitle_three }}">
