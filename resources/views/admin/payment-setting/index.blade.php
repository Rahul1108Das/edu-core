                            ...
                            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="#paypal-setting" class="nav-link active" data-bs-toggle="tab"
                                        aria-selected="true" role="tab">Paypal Settings</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#razorpay-setting" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                                        tabindex="-1" role="tab">Razorpay Settings</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active show" id="paypal-setting" role="tabpanel">
                                    <form action="{{ route('admin.paypal-setting.update') }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Paypal mode</label>
                                                    <select name="paypal_mode" class="form-control">
                                                        <option @selected( config('gateway_settings.paypal_mode') === 'sandbox' ) value="sandbox">Sandbox</option>
                                                        <option @selected( config('gateway_settings.paypal_mode') === 'sandbox' ) value="live">Live</option>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="paypal_currency" class="form-control select2">
                                                        @foreach (config('gateway_currencies.paypal_currencies') as $key => $value)
                                                            <option @selected( config('gateway_settings.paypal_currency') === $value['code'] ) value="{{ $value['code'] }}">{{ $value['code'] }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Rate (USD)</label>
                                ...
                                <div class="tab-pane" id="stripe-setting" role="tabpanel">
                                    <form action="{{ route('admin.stripe-setting.update') }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Stripe Status</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="stripe_currency" class="form-control select2">
                                                        @foreach (config('gateway_currencies.stripe_currencies') as $key => $value)
                                                            <option @selected( config('gateway_settings.stripe_currency') === $value ) value="{{ $value }}">{{ $value }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Publishable Key</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Stripe Secret</label>
                                                    <input type="text" class="form-control" name="stripe_secret"
                                                        placeholder="Enter Stripe Secret" value="{{ config('gateway_settings.stripe_secret') }}">
                                ...
                                <div class="razorpay-setting" id="tabs-activity-5" role="tabpanel">
                                    <form action="{{ route('admin.razorpay-setting.update') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Razorpay Status</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="razorpay_currency" class="form-control select2">
                                                        @foreach (config('gateway_currencies.razorpay_currencies') as $key => $value)
                                                            <option @selected( config('gateway_settings.razorpay_currencies') === $value ) value="{{ $value }}">{{ $value }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Razorpay Key</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Razorpay Secret</label>
                                                    <input type="text" class="form-control" name="razorpay_secret"
                                                        placeholder="Enter Razorpay Secret" value="{{ config('gateway_settings.razorpay_secret') }}">
