    ...
    <div class="col-12 col-md-9 d-flex flex-column">
        <form action="{{ route('admin.logo-settings.update') }}" method="POST" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md--12">
                        <x-image-preview src="{{ asset(config('settings.site_logo')) }}" style="width: 300px; height: 100px;"/>
                        <x-input-file-block name="site_logo"/>
                    </div>
                    <div class="col-md--12">
                        <x-image-preview src="{{ asset(config('settings.site_footer_logo')) }}" style="width: 300px; height: 100px;"/>
                ...
                <div class="card-footer bg-transparent mt-auto">
                    <div class="btn-list justify-content-end">
                        <button type="submit" href="#" class="btn btn-primary btn-2"> Update </button>
                    </div>
                </div>
        </form>
    </div>
