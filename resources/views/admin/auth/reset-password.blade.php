          ...
          <div class="card-body">
            ...
            <form action="{{ route('admin.password.store') }}" method="POST" autocomplete="off" novalidate>
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" :value="old('email', $request->email)" required placeholder="your@email.com" autocomplete="off">
              </div>
              <x-input-error :messages="$errors->get('email')" class="mt-2" />
                ...
                <div class="mb-2">
                  ...
                  <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">
                      <input type="password confirm-password" class="form-control"  placeholder="Your password" name="password_confirmation" required autocomplete="off">
